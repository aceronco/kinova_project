...
def move_square(base, base_cyclic, repetitions=2):
    # Definir los puntos de la trayectoria cuadrada
    path = [

        {"x": 0.360, "y":  0.400, "z": 0.0200, "theta_x": 90.000, "theta_y": 0.000, "theta_z": 150.000}, #NW
        {"x": 0.200, "y": 0.400, "z":  0.0200, "theta_x": 90.000, "theta_y": 0.000, "theta_z": 150.000}, #SW
        {"x": 0.200, "y": -0.200, "z": 0.0200, "theta_x": 90.000, "theta_y": 0.000, "theta_z": 150.000}, #SE
        {"x": 0.3600, "y": -0.200, "z": 0.0200, "theta_x": 90.000, "theta_y": 0.000, "theta_z": 150.000}, #NE
...
def main():
    ...
    with utilities.DeviceConnection.createTcpConnection(args) as router:
        ...
        move_square(base, base_cyclic, repetitions=2)
