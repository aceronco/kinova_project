#trayectoria cuadrada, primero debe ir a home
import threading
import sys
import os
...
# Función para mover a la trayectoria cuadrada
def move_square(base, base_cyclic):
    ...
    path = [
        ...
        {"x": 0.400, "y": 0.200, "z": 0.400, "theta_x": 90.000, "theta_y": 0.000, "theta_z": 150.000}  # Regresar al punto inicial
    ]
    
    # Recorrer la trayectoria cuadrada y mover el robot a cada punto
...
def main():
    ...
    with utilities.DeviceConnection.createTcpConnection(args) as router:
        ...
        # Mover a la trayectoria cuadrada
        move_square(base, base_cyclic)
