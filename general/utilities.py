...
def parseConnectionArguments(parser = argparse.ArgumentParser()):
    ...
    parser.add_argument("-u", "--username", type=str, help="username to login", default="estudiantes")
    parser.add_argument("-p", "--password", type=str, help="password to login", default="KINOVA-UMNG")
